...
public class MainActivity extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    private Activity mAcivity = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rInAnim = AnimationUtils.loadAnimation(mAcivity,R.anim.push_right_in);
        rOutAnim = AnimationUtils.loadAnimation(mAcivity,R.anim.push_right_out);
        lInAnim = AnimationUtils.loadAnimation(mAcivity,R.anim.push_left_in);
        lOutAnim = AnimationUtils.loadAnimation(mAcivity,R.anim.push_left_out);
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        if(e2.getX() - e1.getX()>FLING_MIN_DISTANCE&&Math.abs(velocityX)>FLING_MIN_VELOCITY){
            ...
            setTitle("相册编号:"+viewFlipper.getDisplayedChild());
            return true;
